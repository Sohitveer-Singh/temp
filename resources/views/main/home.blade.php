<x-main-layout>
    ...
    <main>
        ...
        <section class="rr-hero-area rr-hero-bg pt-120 pb-120 p-relative ">
            <div class="rr-hero-main-shap">
                <div class="rr-hero-shap-1 d-none d-xxl-block">
                    <img src="{{ asset('assets/img/hero/shap.png')}}" alt="">
                </div>
                <div class="rr-hero-shap-2">
                    <img src="{{ asset('assets/img/hero/shape2.png')}}" alt="">
                </div>
                <div class="rr-hero-shap-3">
                    <img src="{{ asset('assets/img/hero/shape3.png')}}" alt="">
                </div>
                <div class="rr-hero-shap-4">
                    <img src="{{ asset('assets/img/hero/shape4.png')}}" alt="">
                </div>
            </div>
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <div class="rr-hero-banner">
                                ...
                                <h2 class="rr-hero-title wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">Your
                                    Advanced
                                    and Number One Marriage Bureau</h2>
                                <p class=" wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                                    We will help you achieve your dream match. <br>From arranging family meetings to managing appointments <br>with potential partners, we handle everything for you. <br>Our goal is to make the entire process smooth and stress-free,<br> ensuring you find the perfect life partner.
                                </p>
                                <div class="rr-hero-banner-info d-flex align-items-center ">
                                    <div class="rr-hero-banner-btn mr-35 wow rrfadeUp" data-wow-duration=".9s"
                                        ...
                                        ?>
                                        <a class="rr-btn" href="tel:<?php echo $contact_phone; ?>"><span>Contact Us Now </span><i class="fa-solid fa-arrow-right"></i></a>
                                    </div>
        ...
        <!-- hero area end -->
        <!-- about area start -->
        <section class="rr-about-area pt-120 pb-30 fix" id="about">
            <div class="container">
                <div class="row gx-30">
                    <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 p-relative wow rrfadeUp" data-wow-duration=".9s"
                        ...
                        <div class="rr-about-thumb rr-about-img d-flex align-items-center justify-content-center"
                             data-background="{{ asset('assets/img/about/img.png')}}">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <span class="rr-section-subtitle wow rrfadeUp" data-wow-duration=".9s"
                              data-wow-delay=".3s">About Brulloft</span>
                                ...
                                <p class=" wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">Our matchmaking and coordination services are tailored for any budget, meaning everyone can benefit from our expertise. Our services are designed to make the entire process of finding your perfect match as smooth and personalized as possible.</p>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 p-relative wow rrfadeUp" data-wow-duration=".9s"
                         data-wow-delay=".9s">
                        <div class="rr-about-thumb rr-about-img d-flex align-items-center justify-content-center"
                             data-background="{{ asset('assets/img/about/img-2.png')}}">
                            <img src="{{asset('assets/img/about/shape.png')}}" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="rr-funfact-area pt-60 pb-100 p-relative fix">
            <div class="container">
                <div class="rr-funfact-shap d-none d-lg-block">
                    <img src="{{ asset('assets/img/counter/full01.png')}}" alt="">
                </div>
                <div class="rr-funfact-shap-2 d-none d-lg-block">
                    <img src="{{ asset('assets/img/counter/full02.png')}}" alt="">
                </div>
                <div class="rr-funfact">
                    <div class="row gx-30">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow rrfadeUp" data-wow-duration=".9s"
                             data-wow-delay=".3s">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow rrfadeUp" data-wow-duration=".9s"
                            ...
                            <div class="rr-funfact-content text-center fix p-relative">
                                <div class="rr-funfact-number d-flex align-items-center justify-content-center">
                                    <h5 class="rr-funfact-number purecounter" data-purecounter-duration="1"
                                        data-purecounter-end="4000">0</h5>
                                    <b>+</b>
                                </div>
                                <div class="rr-funfact-text">
                                    <span>Contacted</span>
        ...
        <!-- fact area end -->
        <!-- service area start -->
{{--        <section class="rr-service-area pt-20 pb-50 p-relative fix" id="service">--}}
...
{{--                                <h4 class="rr-service-title"><a href="#service">Flower Design</a></h4>--}}
...
{{--                            </div>--}}
{{--                            <div class="rr-service-content">--}}
{{--                                <h4 class="rr-service-title"><a href="#service">Wedding Co-ordinate</a></h4>--}}
{{--                                <p>Flower design is important in weddings <br /> became enhances whole mood and beauty to--}}
{{--                                    location.</p>--}}
...
{{--                            </div>--}}
{{--                            <div class="rr-service-content">--}}
{{--                                <h4 class="rr-service-title"><a href="#service">Photoshoot</a></h4>--}}
{{--                                <p>Flower design is important in weddings <br /> became enhances whole mood and beauty to--}}
{{--                                    location.</p>--}}
...
{{--                            </div>--}}
{{--                            <div class="rr-service-content">--}}
{{--                                <h4 class="rr-service-title"><a href="#service">Makeup Artist</a></h4>--}}
{{--                                <p>Flower design is important in weddings <br /> became enhances whole mood and beauty to--}}
{{--                                    location.</p>--}}
...
{{--                            </div>--}}
{{--                            <div class="rr-service-content">--}}
{{--                                <h4 class="rr-service-title"><a href="#service">Invitation</a></h4>--}}
{{--                                <p>Flower design is important in weddings <br /> became enhances whole mood and beauty to--}}
{{--                                    location.</p>--}}
...
{{--                            </div>--}}
{{--                            <div class="rr-service-content">--}}
{{--                                <h4 class="rr-service-title"><a href="#service">Best Restaurant</a></h4>--}}
{{--                                <p>Flower design is important in weddings <br /> became enhances whole mood and beauty to--}}
{{--                                    location.</p>--}}
                        ...
                        <div class="rr-testimonial-active swiper-container wow rrfadeUp" data-wow-duration=".9s"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="rr-testimonial-item d-flex align-items-start">
                                        <div class="rr-testimonial-thumb mr-20">
                                            <img src="{{asset('assets/img/testimonial/avada.png')}}" alt="">

                                        </div>
                                        <div class="rr-testimonial-content">
                                            <div class="rr-testimonial-star flex">
                                    <span><svg width="24" height="22" viewBox="0 0 24 22" fill="none"
                                          ...
                                          <path
                                            ...
                                            <p>We are so grateful to this marriage bureau for helping us find the perfect match for me. The team was professional, understanding, and worked hard to accommodate our preferences. Their approach was very personalized, and we were impressed with how they handled every step of the process. We couldn't have asked for a better experience!
                                            </p>
                                            <h4 class="rr-testimonial-title">Karanveer Singh</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="rr-testimonial-item d-flex align-items-start">
                                        <div class="rr-testimonial-thumb mr-20">
                                            <img src="{{ asset('assets/img/testimonial/simrankaur.png')}}" alt="">
                                        </div>
                                        <div class="rr-testimonial-content">
                                            <div class="rr-testimonial-star flex">
                                                <div class="rr-testimonial-star flex">
                                       <span><svg width="24" height="22" viewBox="0 0 24 22" fill="none"
                                            ...
                                            <p>Thanks to this marriage bureau, I met my life partner! The platform provided me with great options that matched my background and values. The staff was very supportive, and I appreciated the attention to detail. It's the best place to find a genuine match!
                                            </p>
                                            <h4 class="rr-testimonial-title">Simran Kaur</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="rr-testimonial-item d-flex align-items-start">
                                        <div class="rr-testimonial-thumb mr-20">
                                            <img src="{{ asset('assets/img/testimonial/singhfamily.png')}}" alt="">
                                        </div>
                                        <div class="rr-testimonial-content">
                                            <div class="rr-testimonial-star flex">
                                    <span><svg width="24" height="22" viewBox="0 0 24 22" fill="none"
                                          ...
                                          <path
                                            ...
                                            <p>We had been looking for a good marriage bureau for our son and were recommended to try this marriage bureau. From the very first meeting, we knew we were in the right place. The team took the time to understand our preferences and cultural background, which made the process smooth and stress-free. We are thrilled with the outcome!
                                            </p>
                                            <h4 class="rr-testimonial-title">The Singh Family</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="rr-testimonial-item d-flex align-items-start">
                                        <div class="rr-testimonial-thumb mr-20">
                                            <img src="{{ asset('assets/img/testimonial/harpreetsingh.png')}}" alt="">
                                        </div>
                                        <div class="rr-testimonial-content">
                                            <div class="rr-testimonial-star flex">
                                                <div class="rr-testimonial-star flex">
                                       <span><svg width="24" height="22" viewBox="0 0 24 22" fill="none"
                                            ...
                                            <p>Finding a life partner through this marriage bureau was a wonderful experience. The team guided me every step of the way, ensuring I felt comfortable and informed throughout. They truly made the matchmaking process seamless and helped me meet the love of my life. I highly recommend their services!
                                            </p>
                                            <h4 class="rr-testimonial-title">Harpreet Singh</h4>
